...
- [ ] Accessibility setting to make the camera shake less
- [ ] Initial cutscene telling the story

## Extra Credits

### Assets

**3D Models** (downloaded from [The Models Resource](https://www.models-resource.com/)):
...
- Sackboy (© Sony Interactive Entertainment / Media Molecule)
- Bulborb (© Nintendo)
- Pikmin (© Nintendo)
- Glamrock Freddy (© Scott Cawthon / Five Nights at Freddy's)
- Cake asset (© Irrational Games / 2K Games)

**Other Assets:**

- Free Pack - Loot Box (downloaded from [Fab](https://www.fab.com/), PolyOne Studio)
- Bodycam Backroom VHS Effect (downloaded from Fab, Kaizen Digital Interactive)
- Mario Kart: Super Circuit item box texture (© Nintendo)

### Music and SFX

- "Looping the Rooms (Lofi Magical Mix)" by Magic
- "Master Core" (Super Smash Bros. for Nintendo 3DS / Wii U) by BANDAI NAMCO Studios Inc.
- "Cursed Cathedral - Remix | SMW Greatest Hits (Mario's Mystery Meat)" by RAMIYORU
- "Ending" (Super Mario World) composed by Koji Kondo
- "Accumula Town" (Pokémon Black & White) composed by Shota Kageyama
- "It is a mystery" by TBD
- Among Us kill sound effect (© Innersloth)
- Rolling sound effect from TBD
- Various Kirby sound effects (© Nintendo / HAL Laboratory)
...
If you are missing or know someone who is missing from the credits, please let me know!
